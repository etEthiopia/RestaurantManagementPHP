...
<h4 class="text-center pb-3">Managing Hours</h4>

<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-open-tab" data-toggle="tab" href="#nav-open" role="tab" aria-controls="nav-open" aria-selected="true">Working Hours</a>
    <a class="nav-item nav-link" id="nav-close-tab" data-toggle="tab" href="#nav-close" role="tab" aria-controls="nav-close" aria-selected="false">Holidays</a>
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-open" role="tabpanel" aria-labelledby="nav-open-tab">
    ...
    <?php 
      require('../models/date_management.php');?>
              ...
              <div class="form-group">
                <label for="opening_upd">Open from:</label>
              <input type="time" class="form-control" id="opening_upd" name="opening_upd" required>
              </div>

              <div class="form-group">
                <label for="closing_upd">Up to:</label>
              <input type="time" class="form-control" id="closing_upd" name="closing_upd" required>
              </div>

              <button type="submit" name="date_upd" id="date_upd" class="submit-btn btn btn-dark d-block mr-auto ml-auto">Submit</button>
              </form>
  </div>
  ...
  <div class="tab-pane fade" id="nav-close" role="tabpanel" aria-labelledby="nav-close-tab">
    ...
    ?>
              ...
              <button type="submit" name="day_close" id="day_close" class="submit-btn btn btn-dark d-block mr-auto ml-auto">Submit</button>
              <?php if (isset($fail)): ?>
